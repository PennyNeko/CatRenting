...
Vue.component('form-login',{
    template:`  
   <card v-show="isLoggedIn" style="width: 500px ;" class="m-auto"> 
        <card-block >    
        
           <h2 class="card-title"> Hey you! I want you to login :)</h2>
    ...
    methods:{
        uploadFiles:function(){
            ...
            for(i=0; i<input.files.length;i++){
                ...
                this.id!=="library"? data.append('id',this.id):'';
                fetch(url+'type=FilesUpload&order='+i,{
                    method:"POST",
                    body:data
                })
                    .then(resp=>resp.json())
